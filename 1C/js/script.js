...
var userAgent = navigator.userAgent.toLowerCase(),
	...
	plugins = {
		...
		customActive: $("[data-custom-active]"),
...
$document.ready(function () {
	 ...
	 * Custom Active
	 */
	if (plugins.customActive.length) {
		var i;
		for (i = 0; i < plugins.customActive.length; i++) {
			var $this = $(plugins.customActive[i]);
			$this.on('click', function (e) {
				e.preventDefault();
				$("#" + $(this).attr('data-custom-active')).add('li').removeClass('active');
				$("#" + $(this).attr('data-custom-active')).add(this).addClass('active');
			});

			if ($this.attr("data-custom-active-disable-on-blur") === "true") {
				$("body").on("click", $this, function (e) {
					if (e.target !== e.data[0] && $("#" + e.data.attr('data-custom-active')).find($(e.target)).length == 0 && e.data.find($(e.target)).length == 0) {
						$("#" + e.data.attr('data-custom-active')).add(e.data[0]).removeClass('active');
					}
				})
			}
		}
